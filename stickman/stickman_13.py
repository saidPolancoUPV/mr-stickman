...
platform1 = PlatformSprite(g, PhotoImage(file='./imgs/platform1.gif'), 0, 480, 100, 10)
platform2 = PlatformSprite(g, PhotoImage(file='./imgs/platform1.gif'), 150, 440, 100, 10)
platform3 = PlatformSprite(g, PhotoImage(file='./imgs/platform1.gif'), 300, 400, 100, 10)
platform4 = PlatformSprite(g, PhotoImage(file='./imgs/platform1.gif'), 300, 160, 100, 10)
platform5 = PlatformSprite(g, PhotoImage(file='./imgs/platform2.gif'), 175, 350, 66, 10)
...
platform9 = PlatformSprite(g, PhotoImage(file='./imgs/platform3.gif'), 170, 250, 32, 10)
platform10 = PlatformSprite(g, PhotoImage(file='./imgs/platform3.gif'), 230, 200, 32, 10)

man = StickFigureSprite(g)

door = DoorSprite(g, PhotoImage(file='./imgs/door1.gif'), 45, 30, 40, 35)
